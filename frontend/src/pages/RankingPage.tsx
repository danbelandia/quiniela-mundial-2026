        ...
        <table className="w-full text-left min-w-[320px]">
          <thead>
            <tr className="bg-gray-100 text-tm-blue uppercase text-sm">
              ...
              <th className="p-2 md:p-3 text-center">Ptos.Partidos</th>
              <th className="p-2 md:p-3 text-center">Ptos.Clasif</th>
              <th className="p-2 md:p-3 text-center">Ptos.Goleador</th>
      ...
      <div className="mt-8 border-t-2 border-tm-blue pt-6">
        ...
        <div className="overflow-x-auto -mx-6 px-6">
          <table className="w-full text-left min-w-[360px]">
            <thead>
              <tr className="bg-gray-100 text-tm-blue uppercase text-sm">
                <th className="p-2 md:p-3">Condición</th>
                <th className="p-2 md:p-3 text-center">Puntos</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b">
                <td className="p-2 md:p-3">Marcador exacto (incluye empates exactos)</td>
                <td className="p-2 md:p-3 text-center font-bold text-green-600">3</td>
              </tr>
              <tr className="border-b">
                <td className="p-2 md:p-3">Ganador correcto, marcador incorrecto</td>
                <td className="p-2 md:p-3 text-center font-bold text-tm-blue">2</td>
              </tr>
              <tr className="border-b">
