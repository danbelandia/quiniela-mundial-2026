...
Read-only view of any logged-in user's predictions for the world cup matches, grouped by group. Used from the ranking page to drill into a competitor's picks.
